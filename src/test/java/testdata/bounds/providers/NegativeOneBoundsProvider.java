...
public class NegativeOneBoundsProvider implements ArgumentsProvider {

    static final FiniteBound<?>[] NEGATIVE_ONE_BOUNDS = {
            ...
            new ImmutableFiniteBound<>(BigInteger.ONE.negate()),
            new ImmutableFiniteBound<>(BigDecimal.ONE.negate()),
            new ImmutableFiniteBound<>(ComparableNumber.NEGATIVE_ONE)
    };

    @Override
    public Stream<? extends Arguments> provideArguments(ExtensionContext context) {
        return Arrays.stream(NEGATIVE_ONE_BOUNDS).map(Arguments::of);
    }
}
